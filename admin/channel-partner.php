...
if(isset($sub))
{
        ...
        if($size <= 150000){
            if($ext == "jpg" || $ext == "jpeg" || $ext == "png"){
             ...
             $fnn = rand(11111,99999).'.'.$ext;
             
                 if(mysqli_query($con,"insert into channel_partner (img) values('$fnn')"))
        	        {
        	              if(move_uploaded_file($tmp,"img/our_partner/".$fnn))
        	              {
        	                 echo "<script>alert('Image added successfully.')</script>";   
        	              }
        	              else
        	              {
        	                  echo "<script>alert('Error while udating Image.')</script>";      
        	              }
        	        }
            ...
            echo "<script>alert('image size should be max 150 kb.')</script>";
        }
...
<head>
    ...
    <title>Channel Partner | ATG TUFF</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Channel Partner</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#">Upload Channel Partner</a></li>
